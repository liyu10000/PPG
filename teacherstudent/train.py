...
class Trainer(object):
    ...
    def __init__(self, model, cfg):
        ...
        self.label_qua_dir = cfg.label_qua_dir
        self.label_info_file = cfg.label_info_file
        self.useLow = True if cfg.useLow == 'yes' else False
        self.ratios = [cfg.high_r, cfg.low_r, cfg.total_r]
        ...
        self.dataloaders = {
            phase: generator(
                ...
                label_qua_dir=self.label_qua_dir,
                label_info_file=self.label_info_file,
                useLow=self.useLow,
                ratios=self.ratios,
                phase=phase,
