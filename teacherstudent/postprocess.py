...
def update_patch(manual_dir, pred_dir, update_patch_dir, name, hws, cmd='union', patch_size=224):
...
def update_patch_mp(manual_dir, pred_dir, manual_patch_dir, update_patch_dir, cmd):
    ...
    for name, hws in file_dict.items():
        tasks.append(executor.submit(update_patch, manual_dir, pred_dir, update_patch_dir, name, hws, cmd))
...
if __name__ == '__main__':
    ...
    cmd = 'union'
    update_patch_mp(manual_dir, pred_dir, manual_patch_dir, update_patch_dir, cmd)