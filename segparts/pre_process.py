...
if __name__ == "__main__":
    ...
    phase = "val"
    pad = False
    dataset = PPGDataset(label_dict, class_index, mean, std, phase, 640, 480, pad)
    ...
    if checking:
        ...
        image_dir2 = "../data/labeled/images_jpg_3cls"
        label_dir2 = "../data/labeled/labels_jpg_3cls"
    ...
    for i in range(len(dataset)):
        ...
        if checking:
            ...
            cv2.imwrite(os.path.join(image_dir2, name+'_jpg9099.png'), img)
            cv2.imwrite(os.path.join(label_dir2, name+'_jpg9099.png'), mask)
        # break
